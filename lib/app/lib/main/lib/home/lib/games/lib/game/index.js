...
function render (component) {
  ...
  let playerList = dom('td', [dom('span', {class: 'Games-players'}, game.players.length + '/6')])
  let status = dom('td', [dom('span', {class: 'Games-status'}, (game.active) ? 'In Progress' : 'Open')])
